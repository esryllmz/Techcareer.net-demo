    ...
    <div className="container">
      ...
      <div className="left-section">
        <div className="header">
          ...
          <img src="img/Group 4.png" alt="Laptop Illustration" className="illustration" />
        </div>
      </div>
      ...
      <div className="right-section">
        <div className="box">
          ...
          <div className="box-content">
            <h2>Ücretsiz Etkinlikler ve Eğitimlerle Başla</h2>
            <p>
        ...
        <div className="box">
          <div className="box-content">
            <h2>Kendini Kanıtla ve Komüniteyle Güçlen</h2>
            <p>
          ...
          <img src="img/icon-hackathon 1 (2).png" alt="Icon 2" className="icon" />
        </div>

        <div className="box">
          <img src="img/icon-hackathon 1 (1).png" alt="Icon 3" className="icon" />
          <div className="box-content">
            <h2>Kariyer Yolculuğuna Rehberlik Et</h2>
            <p>
